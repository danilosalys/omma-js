...
btnEnviar.onclick = (evento) => {
  //previne o comportamento padrão ( impede que a pagina seja recarregada)
  evento.preventDefault();
  //alert('formulario enviado!');

  //selecionando campso do formulario
  let inputTitulo = document.querySelector("#titulo");
  let inputDificuldade = document.querySelector("#dificuldade");
  let inputIngredientes = document.querySelector("#preparo");
